...
const projects = [
  ...
  },
  {
    ...
    description: "Republic Day campaign celebrating movement and unity through dance",
...
function Navigation() {
  ...
  const close = reactExports.useCallback(() => setMenuOpen(false), []);
  const navLinks = [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-[background,border-color,box-shadow] duration-300 ${scrolled ? "nav-glass shadow-xs" : "bg-transparent border-transparent"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "max-w-7xl mx-auto px-6 lg:px-12 h-16 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href: "#hero",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "O" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent", children: "P" })
              ]
            }
          ),
        ...
        menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden nav-glass border-t border-border px-6 py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col gap-6", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: link.href,
            "data-ocid": "nav.link",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            "aria-hidden": "true",
            style: {
              background: "radial-gradient(ellipse 80% 50% at 50% 60%, oklch(0.94 0.02 40 / 0.25) 0%, transparent 70%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            "aria-hidden": "true",
            style: {
              backgroundImage: "linear-gradient(oklch(0.12 0 0) 1px, transparent 1px), linear-gradient(90deg, oklch(0.12 0 0) 1px, transparent 1px)",
              backgroundSize: "80px 80px"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-5xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "hero-animate-1 font-body text-xs tracking-[0.3em] uppercase text-muted-foreground mb-8", children: "Creative Director" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "hero-animate-2 font-display font-black leading-[0.9] tracking-tight text-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-[clamp(3.5rem,12vw,8rem)]", children: "Omkar" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-[clamp(3.5rem,12vw,8rem)]", children: "Potdar" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "hero-animate-3 mt-8 max-w-2xl mx-auto font-body text-[clamp(1.05rem,2.5vw,1.375rem)] leading-relaxed font-light text-muted-foreground", children: [
            '"I turn brand strategy into',
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("em", { className: "not-italic font-medium text-accent", children: "work people care about" }),
            '."'
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hero-animate-4 mt-12 flex flex-wrap items-center justify-center gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: "#work",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            "aria-hidden": "true",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-[10px] tracking-[0.25em] uppercase", children: "Scroll" }),
...
function AboutSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "about", className: "py-32 px-6 lg:px-12 max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ref: titleRef,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs tracking-[0.3em] uppercase text-accent mb-3", children: "02 / About" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-black text-[clamp(2.5rem,6vw,4.5rem)] leading-[0.95] tracking-tight text-foreground", children: [
            "The work.",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            "The thinking."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 w-12 h-0.5 bg-accent", "aria-hidden": "true" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ref: bioRef,
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5 font-body text-base leading-[1.85] text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "I'm a Creative Director with a decade of experience leading creative teams and translating brand strategy into work that connects." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "My background spans",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "font-semibold text-foreground", children: "Audi" }),
              ",",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "font-semibold text-foreground", children: "Hyundai" }),
              ",",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "font-semibold text-foreground", children: "Red Bull" }),
              ",",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "font-semibold text-foreground", children: "Bumble" }),
              ",",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "font-semibold text-foreground", children: "Spotify" }),
              ",",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "font-semibold text-foreground", children: "Netflix" }),
              ",",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "font-semibold text-foreground", children: "Samsung" }),
              " ",
              "and many more international brands and international agencies like",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "font-semibold text-foreground", children: "Condé Nast" }),
              ", and",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "font-semibold text-foreground", children: "Ogilvy" }),
              ". I've led everything from large-scale campaigns to cultural content series, working across brand strategy, visual storytelling, and production. Most recently, I founded and scaled a visual production studio from under ₹1 million to ₹6 million in revenue in one year."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "I think like a strategist and execute like a producer. I build teams that take ownership, bridge cultural authenticity with global brand language, and know when to push creative boundaries and when to refine for impact." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "I bring perspective shaped by India's storytelling traditions and international production experience." })
          ] })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs tracking-[0.25em] uppercase text-muted-foreground mb-8", children: "Capabilities" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-0 divide-y divide-border", children: skills.map((skill, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "li",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-lg text-foreground group-hover:text-accent transition-[color] duration-150", children: skill })
                ]
              },
              skill
            )) })
...
function ProjectCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      style: { transitionDelay: `${index2 % 3 * 60}ms` },
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden aspect-video rounded-none", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  src: thumbnail,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-full bg-white/90 flex items-center justify-center shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "svg",
                {
                  width: "20",
                  height: "20",
                  ...
                  xmlns: "http://www.w3.org/2000/svg",
                  "aria-hidden": "true",
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("polygon", { points: "6,3 17,10 6,17", fill: "black" })
                }
              ) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-0 left-0 right-0 p-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs tracking-widest uppercase text-accent mb-1 font-body", children: project.client }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-white text-base leading-tight", children: project.title })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-3 pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-muted-foreground", children: project.role }) })
          ]
        }
      )
    }
...
function ProjectModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!project, onOpenChange: (open) => !open && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DialogContent,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-full aspect-video bg-black", children: project && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "iframe",
          {
        ...
        project && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs tracking-widest uppercase text-accent mb-1", children: project.client }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-black text-xl text-foreground leading-tight", children: project.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground mt-1", children: project.role }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground mt-2 leading-relaxed", children: project.description }),
...
function WorkSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "work", className: "py-32 px-6 lg:px-12 max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ref: titleRef,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs tracking-[0.3em] uppercase text-accent mb-3", children: "03 / Work" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-black text-[clamp(2.5rem,6vw,4.5rem)] leading-[0.95] tracking-tight text-foreground", children: [
            "Selected",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            "Projects"
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("fieldset", { className: "flex flex-wrap gap-2 mb-12 border-0 p-0 m-0", children: [
      ...
      CATEGORIES.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          className: `font-body text-xs tracking-[0.15em] uppercase px-4 py-2 transition-[background-color,color,border-color] duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring border ${activeFilter === cat ? "bg-accent text-accent-foreground border-accent" : "bg-transparent text-muted-foreground border-border hover:border-accent hover:text-foreground"}`,
          children: cat
        },
        cat
      ))
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: filteredProjects.map((project, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      ProjectCard,
      {
        project,
        index: index2,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ProjectModal, { project: selectedProject, onClose: handleClose })
  ] });
}
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            className: "reveal mb-20",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs tracking-[0.3em] uppercase text-accent mb-3", children: "04 / Contact" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-black text-[clamp(2.5rem,6vw,4.5rem)] leading-[0.95] tracking-tight text-foreground", children: [
                "Let's work",
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                "together."
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            className: "reveal",
            style: { transitionDelay: "100ms" },
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 max-w-md", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-base leading-relaxed text-muted-foreground", children: "Open to creative director roles, brand strategy partnerships, and production collaborations." }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "a",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-10 h-10 flex items-center justify-center border border-border group-hover:border-accent group-hover:bg-accent group-hover:text-accent-foreground transition-[border-color,background-color,color] duration-150", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 16 }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-base text-foreground group-hover:text-accent transition-[color] duration-150", children: "omi.potdar@gmail.com" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "a",
                  {
                    ...
                    className: "flex items-center gap-4 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring rounded-sm",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-10 h-10 flex items-center justify-center border border-border group-hover:border-accent group-hover:bg-accent group-hover:text-accent-foreground transition-[border-color,background-color,color] duration-150", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 16 }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-base text-foreground group-hover:text-accent transition-[color] duration-150", children: "+91 72763 34069" })
                    ]
                  }
                )
              ] }),
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border px-6 lg:px-12 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-xs text-muted-foreground", children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      " Omkar Potdar. All rights reserved."
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-xs text-muted-foreground", children: [
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about-wrapper", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AboutSection, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "work-bg", className: "bg-secondary/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx(WorkSection, {}) }),
